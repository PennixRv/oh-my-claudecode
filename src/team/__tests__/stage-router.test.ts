...
const EXPECTED_DEFAULTS: Record<CanonicalTeamRole, { model: string; agent: string }> = {
  ...
  'test-engineer': { model: CLAUDE_FAMILY_DEFAULTS.HAIKU, agent: 'testEngineer' },
  designer: { model: CLAUDE_FAMILY_DEFAULTS.OPUS, agent: 'designer' },
  ...
  verifier: { model: CLAUDE_FAMILY_DEFAULTS.OPUS, agent: 'verifier' },
  'qa-tester': { model: CLAUDE_FAMILY_DEFAULTS.HAIKU, agent: 'qaTester' },
  scientist: { model: CLAUDE_FAMILY_DEFAULTS.OPUS, agent: 'scientist' },
  tracer: { model: CLAUDE_FAMILY_DEFAULTS.OPUS, agent: 'tracer' },
  'git-master': { model: CLAUDE_FAMILY_DEFAULTS.HAIKU, agent: 'gitMaster' },
};
