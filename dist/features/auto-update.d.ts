...
export declare const REPO_OWNER = "PennixRv";
export declare const REPO_NAME = "oh-my-claudecode";
export declare const GITHUB_API_URL = "https://api.github.com/repos/PennixRv/oh-my-claudecode";
export declare const GITHUB_RAW_URL = "https://raw.githubusercontent.com/PennixRv/oh-my-claudecode";
