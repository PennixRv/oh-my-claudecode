...
- **npm package name**: `oh-my-claude-pennix` (unchanged)

> **Why the difference?** The npm package name `oh-my-claude-pennix` was kept for backward compatibility with existing installations. The project, GitHub repository, plugin, and all commands use `oh-my-claudecode`.
